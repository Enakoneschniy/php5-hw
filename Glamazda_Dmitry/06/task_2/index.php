...
<form action="" method="get">
    <lable for="MultiplicationTable">Таблица умножения</lable>
    <input type="checkbox" name="Multiplication" id="MultiplicationTable"><br>

    <lable for="IdentityMatrix">Еденичная матрица</lable>
    <input type="checkbox" name="Identity" id="IdentityMatrix"><br>

    <lable for="pascal">Триугольник Пскаля</lable>
    <input type="checkbox" name="pascal" id="pascal"><br>
