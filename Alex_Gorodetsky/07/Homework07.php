...
<?
$result=1; // переменная результата по умолчанию - минимально возможное значение факториала
$fact=6; // переменная, число, чей факториал ищем
for($i=1; $i<$fact+1;$i++){
    $result=$result*$i;} // перемножаем все числа по порядку, от единицы до нашего числа
echo $result;
?>